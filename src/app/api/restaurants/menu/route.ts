...
const fallbackMenuItems = [
  {
    ...
    price: 320,
    imageUrl: defaultCategoryImages["Fast Food & Burger"],
  ...
  },
  {
    ...
    price: 280,
    imageUrl: defaultCategoryImages["Biryani & Rice"],
  ...
  },
  {
    ...
    price: 450,
    imageUrl: defaultCategoryImages["Pizza & Pasta"],
...
export async function GET() {
  if (!process.env.DATABASE_URL) {
    return NextResponse.json(fallbackMenuItems, { status: 200 });
  }
